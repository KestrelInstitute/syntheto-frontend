...
class UtilTest {
    ...
    void wrapTopLevel() {
        ...
        String bridgeString = Util.wrapTopLevel(tltype);
        assertEquals("(bridge::try-in-main-thread (nld '(syntheto::translate-to-acl2 " +
    ...
    void wrapCommand() {
        String form = "(u 2)";
        String wrappedForm = Util.wrapCommand(form);
        assertEquals("(bridge::try-in-main-thread (nld '(u 2)))", wrappedForm);
