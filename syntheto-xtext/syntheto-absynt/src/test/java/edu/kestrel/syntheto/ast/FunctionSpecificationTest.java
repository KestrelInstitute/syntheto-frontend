...
public class FunctionSpecificationTest {
    ...
    public static final String checkExpectedType = "(syntheto::function-specificationp " + expectedString + ")";
    ...
    void toSExpression() {
        ...
        SExpression sExpression = funspec.toSExpression();
        assertEquals(expectedString,
                sExpression.toString());

        FunctionSpecification rebuilt = (FunctionSpecification) ASTBuilder.fromSExpression(sExpression);
        assertEquals(funspec, rebuilt);
