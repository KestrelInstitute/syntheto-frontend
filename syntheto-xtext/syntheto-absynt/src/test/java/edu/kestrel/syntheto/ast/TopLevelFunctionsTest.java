...
public class TopLevelFunctionsTest {
    ...
    public static final String expectedString =
            "(SYNTHETO::MAKE-TOPLEVEL-FUNCTIONS :GET (SYNTHETO::MAKE-FUNCTION-RECURSION :DEFINITIONS (LIST " +
    ...
    void toSExpression() {
        ...
        TopLevelFunctions tlfns = TopLevelFunctions.make(recur);
        SExpression sExpr = tlfns.toSExpression();
        assertEquals(expectedString,
                sExpr.toString());

        TopLevelFunctions rebuilt = (TopLevelFunctions) ASTBuilder.fromSExpression(sExpr);
        assertEquals(tlfns, rebuilt);
