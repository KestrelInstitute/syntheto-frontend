...
public class TypeDefinerSumTest {

    public static final String expectedString =
            "(SYNTHETO::MAKE-TYPE-DEFINER-SUM :GET (SYNTHETO::MAKE-TYPE-SUM :ALTERNATIVES (LIST " +
    ...
    void toSExpression() {
        ...
        TypeDefinerSum tdsum = TypeDefinerSum.make(typeSum);
        SExpression sexpr = tdsum.toSExpression();
        assertEquals(expectedString, sexpr.toString());

        TypeDefinerSum rebuilt = (TypeDefinerSum) ASTBuilder.fromSExpression(sexpr);
        assertEquals(tdsum, rebuilt);
