...
public class FunctionDefinerQuantifiedTest {

    public static final String expectedString = "(SYNTHETO::MAKE-FUNCTION-DEFINER-QUANTIFIED " +
    ...
    void toSExpression() {
        ...
        FunctionDefinerQuantified definer = FunctionDefinerQuantified.make(quant, vars, matrix);

        SExpression sExpr = definer.toSExpression();
        assertEquals(expectedString,
                sExpr.toString());

        FunctionDefinerQuantified rebuilt = (FunctionDefinerQuantified) ASTBuilder.fromSExpression(sExpr);
