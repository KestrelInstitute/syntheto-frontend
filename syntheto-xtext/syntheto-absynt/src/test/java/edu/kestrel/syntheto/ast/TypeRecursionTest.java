...
public class TypeRecursionTest {
    ...
    public static final String checkExpectedType = "(syntheto::type-recursionp " + expectedString + ")";
    ...
    void toSExpression() {
        ...
        SExpression sexpr = recursion.toSExpression();
