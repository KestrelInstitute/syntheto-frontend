...
public class FunctionSpecifierInputOutputTest {

    public static final String expectedString =
            "(SYNTHETO::MAKE-FUNCTION-SPECIFIER-INPUT-OUTPUT " +
                    ":RELATION (SYNTHETO::MAKE-EXPRESSION-MULTI :ARGUMENTS (LIST " +
    ...
    void toSExpression() {
        ...
        FunctionSpecifierInputOutput funDefiner = FunctionSpecifierInputOutput.make(retval);

        SExpression sExpression = funDefiner.toSExpression();
        assertEquals(expectedString,
                sExpression.toString());

        FunctionSpecifierInputOutput rebuilt = (FunctionSpecifierInputOutput) ASTBuilder.fromSExpression(sExpression);
