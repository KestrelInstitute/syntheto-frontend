...
public class FunctionDefinitionTest {
    ...
    public static final String checkExpectedType = "(syntheto::function-definitionp " + expectedString + ")";
    ...
    void toSExpression() {
        ...
        SExpression sExpression = def.toSExpression();
        assertEquals(expectedString,
                sExpression.toString());

        FunctionDefinition rebuilt = (FunctionDefinition) ASTBuilder.fromSExpression(sExpression);
        assertEquals(def, rebuilt);
