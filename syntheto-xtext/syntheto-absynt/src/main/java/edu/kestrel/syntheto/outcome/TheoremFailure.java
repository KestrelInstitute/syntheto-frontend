...
/**
 * Outcome of a Syntheto theorem whose proof fails.
 ...
 */
public class TheoremFailure extends Outcome {
    // TODO:
    // this should ideally contain high-level information
    // about why and how the proof failed,
    // but that's a research topic on its own;
    // we could attempt and translate to Syntheto
    // the ACL2 checkpoint subgoals


    /**
     * Constructor.  For this class we only need the inherited String {@code info}.
     */
    private TheoremFailure(String info) {
        super(info);
    }
     ...
     * Static make method.
     *
     * @param info a string describing the theorem failure outcome
     * @return the new TheoremFailure object
     */
    public static TheoremFailure make(String info) {
        return new TheoremFailure(info);
    }
     ...
     */
    public static final SExpressionSymbol classMakerFn = SExpression.syntheto("MAKE-OUTCOME-THEOREM-FAILURE");
    ...
    /**
     * Constructs a TheoremFailure from an S-Expression
     * that looks like
     * (SYNTHETO::MAKE-OUTCOME-THEOREM-FAILURE :MESSAGE MESSAGE)
     *
     * @param buildFormArg The AST maker form.
     * @throws IllegalArgumentException If the list is malformed.
     */
    public static TheoremFailure fromSExpression(SExpression buildFormArg) {
    ...
    public boolean equals(Object o) {
        ...
        TheoremFailure that = (TheoremFailure) o;
    ...
    public String toString(int indentLevel) {
        ...
        s.append(line(indentLevel, "TheoremFailure {"));
