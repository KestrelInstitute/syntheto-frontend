...
/**
 * Syntheto quantified function definer.
 */
public class FunctionDefinerQuantified extends FunctionDefiner {
    ...
    public FunctionDefinerQuantified(Quantifier quantifier,
    ...
    public static FunctionDefinerQuantified make(Quantifier quantifier,
                                                 List<TypedVariable> variables,
                                                 Expression matrix) {
        return new FunctionDefinerQuantified(quantifier, variables, matrix);
    }

    /**
     * The symbol for the ACL2 function that creates an instance of this class.
     */
    public static final SExpressionSymbol classMakerFn = SExpression.syntheto("MAKE-FUNCTION-DEFINER-QUANTIFIED");

    /**
     * Constructs a function definer with quantifier from an S-Expression
     * that looks like
     * (SYNTHETO::MAKE-FUNCTION-DEFINER-QUANTIFIED :QUANTIFIER quantifier :VARIABLES (LIST typedVar...) :MATRIX expression)
     *
     *
     * @param buildFormArg The AST maker form.
     * @throws IllegalArgumentException If the list is malformed.
     */
    public static FunctionDefinerQuantified fromSExpression(SExpression buildFormArg) {
    ...
    public boolean equals(Object o) {
        ...
        FunctionDefinerQuantified that = (FunctionDefinerQuantified) o;
    ...
    String toString(int indentLevel) {
        ...
        s.append(line(indentLevel, "FunctionDefinerQuantified {"));
