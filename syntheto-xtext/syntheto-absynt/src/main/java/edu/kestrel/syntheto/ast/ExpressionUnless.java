...
/**
 * Syntheto unless-then-else expressions.
 */
public class ExpressionUnless extends Expression {
    ...
    private ExpressionUnless(Expression test, Expression then, Expression else_) {
        this.test = test;
        this.then = then;
        this.else_ = else_;
    }

    public static ExpressionUnless make(Expression test,
                                        Expression then,
                                        Expression else_) {
        return new ExpressionUnless(test, then, else_);
    }

    /**
     * The symbol for the ACL2 function that creates an instance of this class.
     */
    public static final SExpressionSymbol classMakerFn = SExpression.syntheto("MAKE-EXPRESSION-UNLESS");

    /**
     * Constructs an Unless expression from an S-Expression
     * that looks like
     * (SYNTHETO::MAKE-EXPRESSION-UNLESS :TEST testExpression :THEN thenExpression :ELSE elseExpression)
     *
     * @param buildFormArg The AST maker form.
     * @throws IllegalArgumentException If the list is malformed.
     * @return
     */
    public static ExpressionUnless fromSExpression(SExpression buildFormArg) {
    ...
    public boolean equals(Object o) {
        ...
        ExpressionUnless that = (ExpressionUnless) o;
    ...
    public String toString(int indentLevel) {
        ...
        s.append(line(indentLevel, "ExpressionUnless {"));
